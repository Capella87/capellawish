...
runserver.port = SECRETS.get("RUNSERVER_PORT", "8000")
...
DATABASES = {
    'default': {
        ...
        'NAME': SECRETS.get('DB_NAME', 'capellawish'),
...
SIMPLE_JWT = {
    ...
    "VERIFYING_KEY": "",
    "AUDIENCE": SECRETS.get("SIMPLE_JWT_AUDIENCE", None),
    "ISSUER": SECRETS.get("SIMPLE_JWT_ISSUER", None),
    "JSON_ENCODER": None,
    "JWK_URL": None,
    "LEEWAY": 0,
